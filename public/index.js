...
class AdMister extends qinpel_cps_1.QinColumn {
    constructor() {
        super();
        this.qinHello = new qinpel_cps_1.QinLabel("Hello, AdMister!");
