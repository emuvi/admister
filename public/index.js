...
class AdMister extends qinpel_cps_1.QinPanel {
    constructor() {
        super();
        const qinDesk = this.qinpel().manager.newDesk(this.qinpel(), (manifest) => manifest.group == "admister");
